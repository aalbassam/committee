...
CREATE TABLE FORMED_COMMITTEES
(
    ...
    FOREIGN KEY (SC_COMMITTEE_ID) REFERENCES COMMITTEES (CC_SID)
...
(
    ...
    PRIMARY KEY (CCM_SID),
    FOREIGN KEY (CCM_FORMATION_NO) REFERENCES FORMED_COMMITTEES (SC_FORMATION_NO),
    FOREIGN KEY (CCM_ROLE_ID) REFERENCES MEMBER_ROLES (CMR_ROLE_ID),
    FOREIGN KEY (CCM_MEMBER_NID) REFERENCES EMPLOYEES (EM_NATIONAL_ID)
);
